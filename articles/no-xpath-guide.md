# Creating Linters Without XPath
...
This is a significant barrier for most R users who just want to enforce
simple coding standards.

## The lintrhelper Solution

`lintrhelper` provides high-level functions that abstract away all the
XPath complexity. You describe **what** you want to lint, not **how** to
find it in the parse tree.
...
to verify your linters work correctly:
...
For complex scenarios that can’t be handled by the high-level functions,
you can still use XPath-based linters:
...
|----|----|----|
| Ban variables | [`forbid_symbols()`](https://fabiandistler.github.io/lintrhelper/reference/forbid_symbols.md) | ❌ No |
| Ban functions | [`forbid_functions()`](https://fabiandistler.github.io/lintrhelper/reference/forbid_functions.md) | ❌ No |
| Naming conventions | [`require_naming_pattern()`](https://fabiandistler.github.io/lintrhelper/reference/require_naming_pattern.md) | ❌ No (just regex) |
| Function names | [`require_function_naming_pattern()`](https://fabiandistler.github.io/lintrhelper/reference/require_function_naming_pattern.md) | ❌ No (just regex) |
| Assignment style | [`enforce_assignment_operator()`](https://fabiandistler.github.io/lintrhelper/reference/enforce_assignment_operator.md) | ❌ No |
| Required args | [`require_function_arguments()`](https://fabiandistler.github.io/lintrhelper/reference/require_function_arguments.md) | ❌ No |
| Line length | [`limit_line_length()`](https://fabiandistler.github.io/lintrhelper/reference/limit_line_length.md) | ❌ No |
